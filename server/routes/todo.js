...
const {getTodos , createTodo,deleteTodo, updateTodo,getTodo} = require('../controllers/todo');
...
// @URL : http://localhost:3001/todo/:id || @Function : GET Todo By ID || @Method : GET || @Middlewares : need to be authentificated
todoRouter.get('/:id',auth,verifyRoles("2020","3030","4040"),getTodo);
